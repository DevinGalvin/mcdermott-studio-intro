...
- **Pace and type (latest):** "so boring, pace and UI." Cut every 0.5–2.6 s; type set 150–700 px, cropped; no card/hairline-label UI look. Each pillar gets its own composition. Overrides the brief's "long holds".
