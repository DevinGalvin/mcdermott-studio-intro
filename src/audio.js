...
export const CUES = {
  pad:  { start: 0.0,  end: 29.0 },  // sustained low pad, beats 1–3
  rise: { start: 29.0, end: 33.3 },  // rising element, beat 4, resolves on the seal
  hit:  { at: 33.3 },                // single low hit on the seal
...
export function buildGraph(ctx, origin, dest = ctx.destination) {
  ...
  padGain.gain.setValueAtTime(0.22, at(26.0));
